#!/bin/bash
# GitHub Action entrypoint script for SDLC Code Scanner
set -e
...
REPORT_DIR="${GITHUB_WORKSPACE}/.sdlc-code-scanner-reports"
...
create_fallback_report_dir() {
    ...
    REPORT_DIR="/tmp/.sdlc-code-scanner-reports"
    mkdir -p "$REPORT_DIR"
...
echo "=============================================="
echo "SDLC Code Scanner - GitHub Action"
echo "=============================================="
echo ""
...
add_step_summary "# SDLC Code Scanner Security Scan Results"
add_step_summary ""
